...
export default function Quest()
{
    ...
    <div className="quest-container">
        ...
        <div class="item quest-header">
            ...
            <h3 class="quest-header"><Link to="/leaderboard" className='ques-board'>Leaderboard</Link></h3>
        ...
        <div className="item content-1">
            <div className="question-content">
                ...
                <div className="inner-quest">
                    ...
                    <button type="button" class="quest-btn btn btn-danger" onclick="location.href='/compiler.html';">Solve</button>
                </div>
                <div class="inner-quest">
                    <h3 class="sub-quest">2. Four Substrings equal</h3>
                    <button type="button" class="quest-btn btn btn-danger">Solve</button>
                </div>
                <div class="inner-quest">
                    <h3 class="sub-quest">3. 8 queen problem</h3>
                    <button onClick={()=>{navigate("/leaderboard")}}type="button" class="quest-btn btn btn-danger">Solve</button>
                </div>
            </div>
        </div>
    </div>
